                                        ...
                                        <Grid columns={2}>
                                            <Grid.Row>
                                                ...
                                                <Grid.Column textAlign={'right'}>
                                                    <h4>{`$${decimalPlace(rider.base_salary,1)}`}</h4>
                                                </Grid.Column>
                                            </Grid.Row>
                                        </Grid>
                                        <Grid columns={2}>
                                            <Grid.Row>
                                                ...
                                                <Grid.Column textAlign={'right'}>
                                                    <h4>{`${decimalPlace(rider.incentive*100,0)}%`}</h4>
                                                </Grid.Column>
                                            </Grid.Row>
                                        </Grid>
                                    </Card.Description>
                                    ...
                                    <Card.Content>
                                        ...
                                        <Grid columns={2}>
                                            <Grid.Row>
                                                ...
                                                <Grid.Column textAlign={'right'}>
                                                    <h3>{`$${decimalPlace(rider.base_salary,1)}`}</h3>
                                                </Grid.Column>
                                            </Grid.Row>
                                            ...
                                            <Grid.Row>
                                                ...
                                                <Grid.Column textAlign={'right'}>
                                                    <h3>{`$${decimalPlace((computeIncentive(item)),1)}`}</h3>
                                                </Grid.Column>
                                            </Grid.Row>
                                            ...
                                            <Grid.Row>
                                                ...
                                                <Grid.Column textAlign={'right'}>
                                                    <h3>{`$${decimalPlace((computeTotalSalary(item)), 1)}`}</h3>
                                                </Grid.Column>
                                            </Grid.Row>
                                        </Grid>
